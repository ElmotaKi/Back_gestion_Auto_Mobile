    ...
    public function rules()
    {
        if ($this->isMethod('post')) {
            ...
            return [
                ...
                'Email' => 'required|string|email|max:255|unique:client_particuliers,Email',
            ...
            return [
                ...
                'Sexe' => 'in:Masculin,Feminin',
                'DateNaissance' => 'string|max:50',
                'Tel' => 'string|max:20',
                'Email' => 'string|email|max:255|unique:client_particuliers,Email',
